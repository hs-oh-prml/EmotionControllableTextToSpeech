...
class FastSpeech2Loss(nn.Module):
    ...
    def forward(self, d_predicted, d_target, p_predicted, p_target, e_predicted, e_target, mel, mel_postnet, mel_target, src_mask, mel_mask):
        d_target.requires_grad = False
        p_target.requires_grad = False
        e_target.requires_grad = False
        mel_target.requires_grad = False
        
        d_predicted = d_predicted.masked_select(src_mask)
        d_target = d_target.masked_select(src_mask)
