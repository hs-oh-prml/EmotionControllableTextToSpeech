...
KSPONSPEECH_VOCAB_PATH = '/sd0/hs_oh/KoSpeech-latest/data/vocab/kspon_sentencepiece.vocab'
KSPONSPEECH_SP_MODEL_PATH = '/sd0/hs_oh/KoSpeech-latest/data/vocab/kspon_sentencepiece.model'
LIBRISPEECH_VOCAB_PATH = '/sd0/hs_oh/KoSpeech-latest/data/vocab/tokenizer.vocab'
LIBRISPEECH_TOKENIZER_PATH = '/sd0/hs_oh/KoSpeech-latest/data/vocab/tokenizer.model'
...
def train(config: DictConfig) -> nn.DataParallel:
    ...
    vocab = KsponSpeechVocabulary(
        f'/sd0/hs_oh/KoSpeech-latest/data/vocab/aihub_{config.train.output_unit}_vocabs.csv',
...
def main(config: DictConfig) -> None:
    ...
    torch.save(last_model_checkpoint, os.path.join("/hd0/hs_oh/KsponSpeech_processed", "last_model_checkpoint.pt"))
